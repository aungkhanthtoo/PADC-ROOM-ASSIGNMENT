...
//                        .observe(this::onNewsFromDb));
    ...
    public void onTapNews(String id) {
        Toast.makeText(this, "NewsID "+id, Toast.LENGTH_SHORT).show();
        Intent intent = NewsDetailsActivity.newIntent(getApplicationContext(), id);
        startActivity(intent);
    }
...
//        event.getNewsId();
//        Intent intent = NewsDetailsActivity.newIntent(getApplicationContext(), event.);
//        startActivity(intent);
    }

    private void onNewsFromDb(List<NewsVO> news) {
        mNewsAdapter.setNewData(news);
    }

//    @Subscribe(threadMode = ThreadMode.MAIN)
//    public void onNewsDataLoaded(RestApiEvents.NewsDataLoadedEvent event) {
//        Log.d(NewsListActivity.class.getSimpleName(), "onNewsDataLoaded: " + event.getLoadNews().size());
